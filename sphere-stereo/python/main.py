...
if __name__ == "__main__":
    ...
    # Explicitly specify original resolution for our test images
    original_resolution = [1944, 1096]  # Based on actual image size (width, height)
    calibrations = parse_json_calib(raw_calibration, args.matching_resolution, args.device, original_resolution)
