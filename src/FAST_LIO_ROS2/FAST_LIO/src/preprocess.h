...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  // void process(const livox_ros_driver2::msg::CustomMsg::UniquePtr &msg, PointCloudXYZI::Ptr &pcl_out);  // Livox-specific - disabled
...
private:
  // void avia_handler(const livox_ros_driver2::msg::CustomMsg::UniquePtr &msg);  // Livox-specific - disabled
